...
import { CreateRider } from "../../services/http/rider/rider";
import { RiderInterface } from "../../interfaces/Irider";
import BG from '../../assets/etc/riderBG.jpg';
import rider from '../../assets/etc/rider.jpg';
import { useNavigate } from 'react-router-dom';
...
const RiderRegister: React.FC = () => {
  ...
  const onFinish = async (values: RiderInterface) => {
    ...
    let res = await CreateRider(values);
            ...
            <Form onFinish={onFinish} autoComplete="off">
              ...
              <div className="registerBox">
                ...
                <div className="rightRegist">
                    ...
                    <Form.Item label="license" name="License"rules={[{required: true,message: "กรุณากรอก license!",},]}>
